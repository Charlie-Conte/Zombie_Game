...
public class Week4_AITargetController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        spawner = GameObject.Find("Zombies");
    ...
    void Update()
    {
        ...
        transform.position = new Vector3(transform.position.x, -1.931097e-08f, transform.position.z);
    ...
    public void kill()
    {
        this.GetComponent<Week4_ZombieAnimationController>().toDie = true;
        this.GetComponent<NavMeshAgent>().enabled = false; 
        this.GetComponent<AICharacterControl>().enabled = false;
        spawner.GetComponent<Week4_SpawnZombies>().zombieList.Remove(gameObject);
